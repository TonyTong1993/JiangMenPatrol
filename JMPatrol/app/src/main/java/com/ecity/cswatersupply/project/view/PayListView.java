...
public class PayListView extends ABaseProjectPropertyView {
    ...
    private void showSecondAttribute(View view, Project project, int tvTitleProjectCode) {
        ...
        builder2.append(project.getAttributeName("createtime")).append(":").append(project.getAttributeValue("createtime")).append("\n").append(project.getAttributeName("paytype"))
                .append(":").append(project.getAttributeValue("paytype")).append("\n").append(project.getAttributeName("smoney")).append(":")
                .append(project.getAttributeValue("smoeny")).append("\n").append(project.getAttributeName("count")).append(":").append(project.getAttributeValue("count"))
