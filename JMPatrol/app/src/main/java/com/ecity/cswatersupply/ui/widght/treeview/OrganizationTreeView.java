...
public class OrganizationTreeView<T> extends LinearLayout {

    private List<T> lDatas;
    private ListView lvTree;
    private OrganizationTreeAdapter<T> adapter;
    ...
    public OrganizationTreeView(Context context) {
        this(context, null);
    }

    public OrganizationTreeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OrganizationTreeView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param lDatas
     */
    public void setDatas(List<T> lDatas, OrganizationTreeAdapter<T> adapter) {
        this.lDatas.clear();
        this.lDatas.addAll(lDatas);
