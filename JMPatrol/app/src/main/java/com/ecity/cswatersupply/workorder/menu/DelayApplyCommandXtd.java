...
public class DelayApplyCommandXtd extends AMenuCommand {
    ...
    public boolean executeWithExtra(View v, Bundle data) {
        ...
        data.putInt(CustomViewInflater.REPORT_TITLE, R.string.title_workorder_delayapply);
        ...
        data.putString(WorkOrderOperator.KEY_CACHE, DelayApplyCommandXtd.class.getName());
        data.putInt(WorkOrderOperator.KEY_EVENTID, UIEventStatus.WORKORDER_COMMON_INSPECT_REPORT);
        data.putInt(WorkOrderOperator.KEY_REPORT_SUCCESS_MSG, R.string.delay_workorder_status);
