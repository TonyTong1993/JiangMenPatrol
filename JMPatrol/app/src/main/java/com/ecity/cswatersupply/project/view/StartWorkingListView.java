...
public class StartWorkingListView extends ABaseProjectPropertyView {
    ...
    private void showSecondAttribute(View view, Project project, int tvTitleProjectCode) {
        ...
        builder2.append("项目编码").append(":").append(project.getAttributeValue("code")).append("\n").append(project.getAttributeName("procost"))
                .append(":").append(project.getAttributeValue("procost")).append("\n").append(project.getAttributeName("kgtime")).append(":")
                .append(project.getAttributeValue("kgtime")).append("\n").append(project.getAttributeName("period")).append(":").append(project.getAttributeValue("period"))
