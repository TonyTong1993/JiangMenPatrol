...
//import com.ecity.cswatersupply.utils.vpn.VpnTestViewActivity;
//import com.ecity.cswatersupply.utils.vpn.VpnTestViewActivity;
...
public class LoginSettingActivity extends Activity {
    ...
    public static void initDefaultServerSettings() {
        ...
        if (SettingsManager.getInstance().getServerType() < 0) {
            SettingsManager.getInstance().setServerType(Constants.TARGET_SERVER_NONE);
        }
        //=========================================================================================
        //设置 默认自定义数据
...
//                    startActivity(intent);
    ...
    private class MyEnvironmentOnSpinnerListener implements OnSpinnerListener {
