...
public class Constants {
    ...
    public static final int TARGET_SERVER_NONE = 2;
    // Target Server end
    ...
    public static final String QUERY_DEVICE_LAYER_IDS = "QUERY_DEVICE_LAYER_IDS";
    ...
    //本地缓存任务关联的
    public static final String CURRENT_USER = HostApplication.getApplication().getCurrentUser().getGid();
    ...
    public static final String IMPORT_EARTH_QUAKE_INFO_PARAM = "import_earth_quake_info_param";
    ...
    public static String WAIT_PROCESS_ORDER = "order by createtime desc";
    public static String EXCUTE_PEOCESS_ORDER ="order by accept_time desc";
    public static String FINISH_PROCESS_ORDER = "order by accept_time desc";
    ...
    // 江门工程人员权限信息key
    public static final String JMGC_KEY_JSDW = "jsdw_role";//建设单位 ，工程部
    public static final String JMGC_KEY_SGDW = "sgdw_role";//施工单位
    public static final String JMGC_KEY_JLDW = "jldw_role";//监理单位
    public static final String JMGC_KEY_SJDW = "sjdw_role";//设计单位 ，技术部
    public static final String JMGC_KEY_GWDW = "gwdw_role";//管网单位
    //网页菜单
