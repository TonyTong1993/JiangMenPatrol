...
public class CustomRenderer {
    ...
    public CustomRenderer() {
        ...
        PIPENETPO_UICOLOR_FORPOINT = Color.argb((int) (0.7 * 256), 0, (int) (256 * 0.7), (int) (256 * 0.1));
        ...
        PIPENETPO_UICOLOR_FORMEASURE_LINE_POINT = Color.argb((int) (0.8 * 256), (int) (0.0 * 256), (int) (256 * 0.0), 255);
        PIPENETPO_UICOLOR_FORMEASURE_LINE_POLY = Color.argb((int) (0.8 * 256), (int) (0.8 * 256), (int) (256 * 0.0), 256 * 0);
    ...
    public SimpleMarkerSymbol PIPENETPO_POINT_CIRCLE_RED(int size) {
        SimpleMarkerSymbol POINT_CIRCLE = new SimpleMarkerSymbol(Color.rgb(255, 128, 0), size, SimpleMarkerSymbol.STYLE.CIRCLE);
    ...
    public SimpleLineSymbol PIPENETPO_LINE_SOLID() {
        SimpleLineSymbol LINE_SOLID = new SimpleLineSymbol(PIPENETPO_UICOLOR_FORLINE, 3, SimpleLineSymbol.STYLE.SOLID);
        return LINE_SOLID;
    }

    public SimpleLineSymbol PIPENETPO_LINE_SOLID_SELECTED() {
        SimpleLineSymbol LINE_SOLID = new SimpleLineSymbol(Color.GREEN, 3, SimpleLineSymbol.STYLE.SOLID);
        return LINE_SOLID;
    }

    public SimpleLineSymbol PIPENETPO_LINE_SOLID_RED() {
        SimpleLineSymbol LINE_SOLID = new SimpleLineSymbol(Color.rgb(255, 128, 0), 10, SimpleLineSymbol.STYLE.SOLID);
        return LINE_SOLID;
    }
    ...
    private Drawable getDrawableByName(String name) {
        int id = -1;
        Resources res = MyApplication.getApplication().getResources();
        try {

            id = res.getIdentifier(name, "drawable", MyApplication.getApplication().getPackageName());
    ...
    public static PictureMarkerSymbol getPictureMarkerSymbolByResuorceName(String name) {
        int id = -1;
        PictureMarkerSymbol symbol = null;
        Resources res = MyApplication.getApplication().getResources();
        try {
            id = res.getIdentifier(name, "drawable", MyApplication.getApplication().getPackageName());
            symbol = getPictureMarkerSymbolByResuorceID(id);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return symbol;
    ...
    public static PictureMarkerSymbol getPictureMarkerSymbolByResuorceID(int resID) {
        return getPictureMarkerSymbolByResuorceID(resID,32,32);
    }
    
    public static PictureMarkerSymbol getPictureMarkerSymbolByResuorceID(int resID,int w,int h) {
        PictureMarkerSymbol symbol = null;
        try {
            Bitmap bmpMarker = BitmapFactory.decodeResource(MyApplication.getApplication().getResources(),resID);
            Drawable drawable = DrawableUtil.createDrawable(bmpMarker,w,h);
