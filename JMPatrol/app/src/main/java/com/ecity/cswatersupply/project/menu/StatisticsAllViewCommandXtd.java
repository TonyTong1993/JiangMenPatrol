...
import com.ecity.cswatersupply.project.activity.StatisticsAllViewActivity;
import com.ecity.cswatersupply.project.activity.fragment.CompleteAcceptListFragment;
import com.ecity.cswatersupply.utils.ResourceUtil;
import com.ecity.cswatersupply.utils.UIHelper;

//竣工验收
public class StatisticsAllViewCommandXtd extends AMenuCommand {
    ...
    public boolean execute() {
        ...
        bundle.putString(ProjectCommonListActivity.INTENT_KEY_TITLE, HostApplication.getApplication().getResources().getString(R.string.statistics_view));
        UIHelper.startActivityWithExtra(StatisticsAllViewActivity.class, bundle);
        return true;
    }
}
