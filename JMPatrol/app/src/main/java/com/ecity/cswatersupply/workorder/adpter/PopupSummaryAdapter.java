 ...
 *
 */
public class PopupSummaryAdapter extends ArrayListAdapter<PopupSummaryModel> {
    private LayoutInflater mLayoutInflater;

    public PopupSummaryAdapter(Context context) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder = null;
        PopupSummaryModel menu = mList.get(position);
        if (convertView == null) {
            holder = new Holder();
