...
public class GPSPositionBean extends ASQLiteBean {
    ...
    public void setInDetourArea(int inDetourArea) {
        this.inDetourArea = 1 == inDetourArea;
    }
    ...
    public void buildFromCursor(Cursor cursor) {
        ...
        this.overspeed = cursor.getInt(15) == 1;
        this.repay = cursor.getInt(16) == 1;
        this.nightWatch = cursor.getInt(17) == 1;
        this.inDetourArea = cursor.getInt(18) == 1;
    }
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (key.equalsIgnoreCase("id")) {
                    ...
                    this.overspeed = jsonObj.getInt(key) == 1;
                } else if (key.equalsIgnoreCase("repay")) {
                    this.repay = jsonObj.getInt(key) == 1;
                } else if (key.equalsIgnoreCase("nightWatch")) {
                    this.nightWatch = jsonObj.getInt(key) == 1;
                } else if (key.equalsIgnoreCase("inDetourArea")) {
                    this.inDetourArea = jsonObj.getInt(key) == 1;
                }
            }
            flag = true;
        } catch (Exception e) {
