...
// */
//
//public class VpnTestViewActivity extends BaseActivity implements IVpnDelegate, View.OnClickListener {
//    private static final String TAG = "SFSDK_" + VpnTestViewActivity.class.getSimpleName();
...
//    private static final String KEY_VPN_SUCCESS = "KEY_VPN_SUCCESS";
//
//    // View
...
//        TextView tv_title = (TextView) findViewById(R.id.tv_title_Login);
//        tv_title.setText("VPN认证");
//
...
//
//        edt_user = (EditText) findViewById(R.id.et_username);
//        edt_passwd = (EditText) findViewById(R.id.et_password);
//        edt_ip = (EditText) findViewById(R.id.et_ip);
//
//
//        edt_user.setText(SettingsManager.getInstance().getVpnUserName());
//        edt_passwd.setText(SettingsManager.getInstance().getVpnUserPsw());
//        edt_ip.setText(SettingsManager.getInstance().getVpnIP());
//
//
//    }
//
...
//                    initSslVpn();
//
//                    SettingsManager.getInstance().setVpnIP(VPN_IP);
//                    SettingsManager.getInstance().setVpnUserName(USER_NAME);
//                    SettingsManager.getInstance().setVpnUserPsw(USER_PASSWD);
//                } else {
...
//                Toast.makeText(VpnTestViewActivity.this, "解析VPN服务器域名失败", Toast.LENGTH_SHORT).show();
//                strHost = "0.0.0.0";
//            }
...
//                    displayToast("认证成功!");
//                    SettingsManager.getInstance().setVpnSuccess(true);
//
