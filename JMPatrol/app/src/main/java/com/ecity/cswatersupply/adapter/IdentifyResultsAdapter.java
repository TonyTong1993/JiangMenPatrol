...
public class IdentifyResultsAdapter extends PagerAdapter {
    ...
    public IdentifyResultsAdapter(ArrayList<Graphic> searchResults, MapActivity activity, MapView mMapView) {
        this.mResults = searchResults;
        this.mMapActivity = activity;
        this.mMapView = mMapView;
        this.mInflater = LayoutInflater.from(mMapActivity);
    }
    ...
    private class MyTvOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            Toast.makeText(mMapActivity, "进入详情页面 ", Toast.LENGTH_SHORT).show();
        }
    }
