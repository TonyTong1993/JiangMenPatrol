...
public class CurrentLocationManager {
    ...
    public static String toJSONString(List<GPSPositionBean> beanList) {
        ...
        if (null != beanList) {
            /*for (GPSPositionBean gpsPositionBean : beanList) {
                Map<String, String> posMap = toMap(gpsPositionBean);
    ...
    public static Location getLocation() {
        ...
        try {
            if (FuZhouPatrolModuleConfig.getConfig().isModuleUseable()){
                ...
                if (PositionService.getLastLocation() != null) {
                    location = PositionService.getLastLocation();
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if(null == location) {
            return PositionService.getLastLocation();
        }
