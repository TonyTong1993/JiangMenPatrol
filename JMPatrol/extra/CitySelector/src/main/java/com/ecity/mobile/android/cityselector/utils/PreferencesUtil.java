package com.ecity.mobile.android.cityselector.utils;
...
public class PreferencesUtil {
    public static String PREFERENCE_NAME = "zizz_citysel_pf";
    /**
	...
	/**
	 * Apply SharedPreferences.Editor changes. If the code runs on API level 9
	 * or higher, the asynchronous method apply is used, otherwise commit.
	 *
	 * @param editor
	 *            the editor that should be commited
	 */
