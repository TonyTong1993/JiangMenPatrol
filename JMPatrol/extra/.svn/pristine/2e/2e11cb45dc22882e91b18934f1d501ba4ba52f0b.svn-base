...
public class CompressUtil {
    ...
    public static File [] unzip(String zip, String dest) throws ZipException {
        ...
        return unzip(zipFile, dest, null,"UTF-8");
    }
     ...
     * @param zip 指定的ZIP压缩文件
     * @param passwd ZIP文件的密码
     * @param charset ZIP文件的密码
     * @return  解压后文件数组
     * @throws ZipException 压缩文件有损坏或者解压缩失败抛出
     */
    public static File [] unzip(String zip,String dest,String passwd,String charset) throws ZipException {
        File zipFile = new File(zip);
        ...
        return unzip(zipFile,dest, passwd,charset);
    }
