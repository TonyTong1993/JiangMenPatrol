...
//		Log.v(TAG,"代理："+host+"，端口："+port);
    ...
    public static void setProxy(DefaultHttpClient client, String proxy) {
        client.getParams().setParameter(ConnRouteParams.DEFAULT_PROXY, new HttpHost(proxy.split(":")[0], Integer.valueOf(proxy.split(":")[1])));
    }
    /**
