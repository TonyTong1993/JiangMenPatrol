...
public class BaseFragmentActivity extends FragmentActivity {
     ...
     * creat LoadingDialog
     */
    public LoadingProgressDialog creatLoadingDialog(String msg,
     ...
     * @version V1.0
     */
    final protected void showLoadingDialog(String msg, boolean cancelable,
     ...
     * show Alert Dialog
     */
    final protected void showAlertDialog(String title, String msg,
            AlertStyle style) {
        AlertView dialog = new AlertView(this, title, msg,
