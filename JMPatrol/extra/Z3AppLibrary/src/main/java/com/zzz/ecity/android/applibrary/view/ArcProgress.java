...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = ScreenUtil.sp2px(getResources(), 18);
        min_size = (int) ScreenUtil.dp2px(getResources(), 100);
        default_text_size = ScreenUtil.sp2px(getResources(), 40);
        default_suffix_text_size = ScreenUtil.sp2px(getResources(), 15);
        default_suffix_padding = ScreenUtil.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = ScreenUtil.sp2px(getResources(), 10);
        default_stroke_width = ScreenUtil.dp2px(getResources(), 4);
