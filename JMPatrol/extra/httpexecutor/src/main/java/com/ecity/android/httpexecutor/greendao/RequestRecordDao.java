...
*/
public class RequestRecordDao extends AbstractDao<RequestRecord, Long> {
    ...
    public RequestRecordDao(DaoConfig config) {
        super(config);
    }
    
    public RequestRecordDao(DaoConfig config, DaoSession daoSession) {
