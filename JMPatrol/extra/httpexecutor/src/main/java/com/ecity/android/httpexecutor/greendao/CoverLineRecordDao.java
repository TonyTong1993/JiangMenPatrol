...
import com.ecity.android.httpexecutor.coverlinerecord.CoverLineRecord;
...
/**
 * DAO for table "REQUEST_RECORD".
 */
public class CoverLineRecordDao extends AbstractDao<CoverLineRecordData, Long> {

    public static final String TABLENAME = "COVER_LINE_RECORD";
    ...
    public CoverLineRecordDao(DaoConfig config) {
        super(config);
    }

    public CoverLineRecordDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"REQUEST_RECORD\" (" + //
                ...
                "\"IS_POST\" INTEGER NOT NULL ," + // 9: requestId
                "\"UUID\" TEXT ," + // 10: requestId
                "\"LINE_ID\" INTEGER NOT NULL );"); // 11: isPost
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, CoverLineRecordData entity) {
        ...
        stmt.bindLong(10, entity.isPost() ? 1L : 0L);
    ...
    public CoverLineRecordData readEntity(Cursor cursor, int offset) {
        CoverLineRecordData entity = new CoverLineRecordData( //
                ...
                cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // createdOn
                cursor.getInt(offset + 11) // requestId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, CoverLineRecordData entity, int offset) {
        ...
        entity.setPost(cursor.getShort(offset + 9) != 0);
