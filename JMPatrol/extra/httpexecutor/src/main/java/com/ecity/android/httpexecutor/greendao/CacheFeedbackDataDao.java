...
/** 
 * DAO for table "CACHE_FEEDBACK_DATA".
*/
public class CacheFeedbackDataDao extends AbstractDao<CacheFeedbackData, Long> {

    public static final String TABLENAME = "CACHE_FEEDBACK_DATA";

    /**
     * Properties of entity CacheFeedbackData.<br/>
    ...
    public static class Properties {
        ...
        public final static Property ResourceId = new Property(11, String.class, "resourceId", false, "RESOURCE_ID");
    ...
    public CacheFeedbackDataDao(DaoConfig config) {
        super(config);
    }
    
    public CacheFeedbackDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CACHE_FEEDBACK_DATA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CACHE_FEEDBACK_DATA\"";
        db.execSQL(sql);
    }
