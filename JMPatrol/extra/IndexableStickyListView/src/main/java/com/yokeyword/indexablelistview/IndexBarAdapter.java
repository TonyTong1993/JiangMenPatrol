...
import com.yokeyword.indexablelistview.pinyin.PinyinComparator;
import com.yokeyword.indexablelistview.pinyin.PinyinUtil;
...
public abstract class IndexBarAdapter<T extends IndexEntity> extends BaseAdapter {
    ...
    protected SparseArray<String> mTitleMap = new SparseArray<String>();
    ...
    private List<String> mHeaderIndexs = new ArrayList<String>();
