...
public class IndexBar extends View {
    ...
    private ArrayList<String> mIndex = new ArrayList<String>();   // List:索引字母
    ...
    private static class SearchHanlder extends Handler {
        ...
        public SearchHanlder(Looper looper, IndexBar indexBar) {
            super(looper);
            mIndexBar = new WeakReference<IndexBar>(indexBar);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            if (indexBar.mFilterList == null) {
                indexBar.mFilterList = new ArrayList<IndexEntity>();
            }
