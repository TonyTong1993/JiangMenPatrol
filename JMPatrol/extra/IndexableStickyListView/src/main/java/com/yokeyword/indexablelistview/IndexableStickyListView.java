...
public class IndexableStickyListView extends FrameLayout implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    private TextView mTvRightOverlay; // 这里以前是AppCompatTextView
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBarSelectedTextColor = a.getColor(R.styleable.IndexableStickyListView_indexBar_selected_textColor, getResources()
                    .getColor(R.color.dafault_indexBar_selected_textColor));
            mRightOverlayColor = a.getColor(R.styleable.IndexableStickyListView_indexListView_rightOverlayColor,
                    getResources().getColor(R.color.default_indexListView_rightOverlayColor));
    ...
    public void addHeaderView(View view) {
        ...
        if (mAddHeaderViewList == null) {
            mAddHeaderViewList = new ArrayList<View>();
        }
    ...
    /**
     * @param show
     *            是否显示IndexListView右侧位置的 悬浮TextView
     */
    ...
    /**
     * @param show
     *            是否显示IndexListView中心位置的 悬浮TextView
     */
    ...
    private static class BindDatasHanlder extends Handler {
        ...
        public BindDatasHanlder(Looper looper, IndexableStickyListView indexListView) {
            super(looper);
            mIndexListView = new WeakReference<IndexableStickyListView>(indexListView);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            if (indexListView.mAdapter.isNeedShutdown())
                return;
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (mTitleHeight == 0 || mTitleMap == null)
            return;
        ...
        mIndexBar.setOnSearchResultListener(new IndexBar.OnSearchResultListener() {
            ...
            public void onResult(boolean isSearch, int dataSize) {
                ...
                if (mAdapter.isFilter()) {
                    ...
                    if (mAddHeaderViewList != null) {
                        for (View view : mAddHeaderViewList) {
                            view.getLayoutParams().height = Integer.parseInt(view.getTag().toString());
                        }
                    }
                    if (mStickView != null && mStickView.getVisibility() != VISIBLE) {
                        mStickView.setVisibility(VISIBLE);
