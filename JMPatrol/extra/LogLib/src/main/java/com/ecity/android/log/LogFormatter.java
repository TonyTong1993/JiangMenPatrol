...
public abstract class LogFormatter {
     ...
     * @return
     */
    public abstract String format(Logger.LEVEL level, String tag, String msg, Throwable tr);
    ...
    public static class EclipseFormatter extends LogFormatter {
        ...
        @Override
        public String format(Logger.LEVEL level, String tag, String msg, Throwable tr) {
            if (level == null || TextUtils.isEmpty(tag) || (TextUtils.isEmpty(msg) && (tr == null))) {
                return "";
            }
