...
public class LogUtil {
    ...
    private static long SINGLE_FILE_MAX_SIZE;

    public static void init(String path, String fileName, String fileSuffix, int logLevel, long singeFileMaxSize) {
        ...
        mlogLevel = logLevel;
        SINGLE_FILE_MAX_SIZE = singeFileMaxSize * 1024 * 1024;
