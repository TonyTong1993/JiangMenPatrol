...
public abstract class LogFilter {
     ...
     * @return
     */
    public abstract boolean filter(Logger.LEVEL level, String tag, String msg);
    ...
    public static class TagFilter extends LogFilter {
        ...
        @Override
        public boolean filter(Logger.LEVEL level, String tag, String msg) {
    ...
    public static class LevelFilter extends LogFilter {
         ...
         */
        public LevelFilter(Logger.LEVEL level) {
            if (level == null) {
