...
public class WatermarkUtil {
    ...
    public static String saveBitmapWithWatermark(Activity activity, String fileName, String fileDir) {
        ...
        try {
            ...
            /*if (SystemUtil.getAppProcessName(getApplicationContext()).equals("com.ecity.cswatersupply.jishouwq")) {

            }*/
//            Bitmap newMap = drawTextOnBitmap(activity, temp, TimeMill2DateUtil.TimeMill2Date(timeMills));
            Bitmap newMap = drawTextOnBitmap(activity, temp, "吉首供水");
...
//        textPaint.setTextSize(TransPixelUtil.sp2px(acitvity, 12, TransPixelUtil.NUMBER_OR_CHARACTER));
        textPaint.setTextSize(TransPixelUtil.sp2px(acitvity, 18, TransPixelUtil.NUMBER_OR_CHARACTER));
//        int margin = 5;
        int margin = 33;
        int y = srcHeight - margin + 14;
